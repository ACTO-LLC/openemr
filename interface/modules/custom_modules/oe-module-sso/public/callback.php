...
try {
    ...
    // Use JavaScript redirect to ensure browser processes Set-Cookie before navigation
    // (Header redirects with SameSite=Strict can cause cookie timing issues)
    ...
    <body>
        ...
        <script>window.location.href = <?php echo json_encode($redirectUrl); ?>;</script>
        <noscript><meta http-equiv="refresh" content="0;url=<?php echo attr($redirectUrl); ?>"></noscript>
    </body>
    </html>
    <?php
    exit;
